...
// Search Car                                                                    /// 1G6DA1E32C0152845  //5TDERKEC3MS057113
    cy.get('[placeholder="Search by make, model"]').type("JN1CV6AR6DM766623")   ///KNDJN2A25F7162188  //5FNRL3H70AB078251
...
// Use a specific attribute, class, or any other unique identifier to select each file input
       cy.get(`input[type="file"]:eq(${index})`).invoke("show").attachFile(file)
       cy.wait(3000)
       cy.get("button").contains("Save and Continue").click()
 });
  cy.wait(3000)
